    ...
    if (localStorage.getItem('slitems')) {
        ...
        $.each(sortedItems, function() {
            ...
            if (item.row.code == 'sub_qty') {
                ...
                tr_html +=
                    '<td class="text-right hide"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' +
                    row_no +
                    '" value="' +
                    item_price +
                ...
                if ((site.settings.product_discount == 1 && allow_discount == 1) || item_discount) {
                    tr_html +=
                        '<td class="text-right hide"><input class="form-control input-sm rdiscount" name="product_discount[]" type="hidden" id="discount_' +
                        row_no +
                        '" value="' +
                        item_ds +
                ...
                tr_html +=
                    '<td class="text-right hide"><span class="text-right ssubtotal" id="subtotal_' +
                    row_no +
                    '">' +
        ...
        var col = ((site.settings.product_serial == 1) ? 4 : 3) + add_col;
        if (site.settings.product_serial == 1) {
            col++;
        }
        ...
        if ((site.settings.product_discount == 1 && allow_discount == 1) || product_discount) {
            tfoot += '<th class="text-right hide">' + formatMoney(product_discount) + '</th>';
        }
        if (site.settings.tax1 == 1) {
            tfoot += '<th class="text-right">' + formatMoney(product_tax) + '</th>';
        }
        tfoot += '<th class="text-right hide">' + formatMoney(total) + '</th><th class="text-center"><i class="fa fa-trash-o" style="opacity:0.5; filter:alpha(opacity=50);"></i></th></tr>';
