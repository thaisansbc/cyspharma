            ...
            <div class="c1">
                <div class="pos">
                    ...
                    <div id="pos">
                        ...
                        if (isset($get_card)) {
                             echo '<div class="title_room">' . $get_card->card_no .'</div>';
                             echo '<input type="hidden" id="card_id" value="' . $get_card->id. '"/>';
                        }
                        ?>
                        <div id="leftdiv">
                            <div id="printhead">
                        ...
                        <div class="col-md-10 col-sm-9">
                            ...
                            <div class="well well-sm well_1">
                                <table class="table table-bordered table-condensed table-striped" style="font-size: 1.2em; font-weight: bold; margin-bottom: 0;">
                                    <tbody>
                                        <tr>
                                            <th width="25%" style="text-align:left;"><?= lang("currency"); ?></th>
                                            <th width="25%" style="text-align:center;"><div id="button_en__" class="btn-info currency button_en"><?= lang("USD"); ?></div></th>
                                            <th width="25%" style="text-align:center;"><div id="button_kh__" class="btn-info currency button_kh"><?= lang("KH"); ?></div></th>
                                            <th width="25%" style="text-align:center;" class="hide"><div id="button_bat__" class="btn-info currency button_kh"><?= lang("BATH"); ?></div></th>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="paid_kh">
                                                <span id="twt_kh">0.00</span>
                                                </div>
                                            </td>
                                            <td class="hide">
                                                <div class="paid_kh ">
                                                <span id="twt_bat">0.00</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("paid")?></td>
                                            <td>
                                                <input currency="kh" name="amount[]" type="text" id="amount_1" class="pa form-control kb-pad1 amount"/>
                                            </td>
                                            <td>
                                                <input currency="en" name="other_cur_paid[]" type="text" id="amount_kh_1" class="pa_kh form-control kb-pad2 amount_kh"/>
                                            </td>
                                            <td class="hide">
                                                <input currency="bat" name="other_cur_paid[]" type="text" id="amount_bat_1" class="pa_bat form-control kb-pad3 amount_bat"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        }elseif ($pos_settings->pos_type == "pos" && !$Settings->module_gym) {
    ...
    <script type="text/javascript">
      ...
      <?php for ($i = 1; $i <= 5; $i++) {?>
        $('#paymentModal').on('change', '#amount_<?=$i?>', function (e) {
            ...
            var amount_usd = $(this).val() ? $(this).val() : 0;
            var amount_khr = $('#amount_kh_<?=$i?>').val() ? $('#amount_kh_<?=$i?>').val() : 0;
            var amount_bat = $('#amount_bat_<?=$i?>').val() ? $('#amount_bat_<?=$i?>').val() : 0;
            $('#amount_val_<?=$i?>').val(parseFloat(amount_usd) + parseFloat(amount_khr / kh_rate) + parseFloat(amount_bat / bat_rate));
        ...
        $('#paymentModal').on('change', '#amount_kh_<?=$i?>', function (e) {
            var kh_rate = localStorage.getItem('exchange_kh');
            var amount_usd = $('#amount_<?=$i?>').val() ? $('#amount_<?=$i?>').val() : 0;
            var amount_khr = $(this).val() ? $(this).val() : 0;
            var amount_bat = $('#amount_bat_<?=$i?>').val() ? $('#amount_bat_<?=$i?>').val() : 0;
            $('#amount_val_<?=$i?>').val(parseFloat(amount_usd) + parseFloat(amount_khr / kh_rate) + parseFloat(amount_bat / bat_rate));
        });
        $('#paymentModal').on('blur', '#amount_kh_<?=$i?>', function (e) {
            var kh_rate = localStorage.getItem('exchange_kh');
            var amount_usd = $('#amount_<?=$i?>').val() ? $('#amount_<?=$i?>').val() : 0;
            var amount_khr = $(this).val() ? $(this).val() : 0;
            var amount_bat = $('#amount_bat_<?=$i?>').val() ? $('#amount_bat_<?=$i?>').val() : 0;
        ...
        $('#paymentModal').on('change', '#amount_bat_<?=$i?>', function (e) {
            var kh_rate = localStorage.getItem('exchange_kh');
            var amount_usd = $('#amount_<?=$i?>').val() ? $('#amount_<?=$i?>').val() : 0;
            var amount_khr = $('#amount_kh_<?=$i?>').val() ? $('#amount_kh_<?=$i?>').val() : 0;
            var amount_bat = $(this).val() ? $(this).val() : 0;
            $('#amount_val_<?=$i?>').val(parseFloat(amount_usd) + parseFloat(amount_khr / kh_rate) + parseFloat(amount_bat / bat_rate));

        });
        $('#paymentModal').on('blur', '#amount_bat_<?=$i?>', function (e) {
            var kh_rate = localStorage.getItem('exchange_kh');
            var amount_usd = $('#amount_<?=$i?>').val() ? $('#amount_<?=$i?>').val() : 0;
            var amount_khr = $('#amount_kh_<?=$i?>').val() ? $('#amount_kh_<?=$i?>').val() : 0;
            var amount_bat = $(this).val() ? $(this).val() : 0;
        ...
        ?>
            ...
            $('#payment').click(function() {
                ...
                <?php if ($pos_settings->rounding) { ?>
                    ...
                    if (currency != 'KHR') {
                        $('#button_en__').text("USD");
                        $('#button_kh__').text("KHR");
                        $('#twt').text('$' + formatMoney(round_total) + ' (' + formatMoney(rounding) + ')');
                    } else {
                        $('#button_en__').text("KHR");
                        $('#button_kh__').text("USD");
                        $('#twt').text(money_comma(round_total) + ' (' + money_comma(rounding) + ')' + '៛');
                    }
                    $('#quick-payable').text(round_total);
                    //-------convert KH to EN--------
                    var gtotal_kh = ((gtotal * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100 : Math.floor((parseFloat(gtotal) * kh_rate) / 100) * 100;
                    var gtotal_bat = parseFloat(gtotal * bat_rate);
                    $('#twt_kh').text('KHR ' + money_comma(gtotal_kh));
                    $('#twt_bat').text('BATH ' + money_comma(gtotal_bat.toFixed(3)));
                <?php } else { ?>
                    ...
                    if (currency != 'KHR') {
                        ...
                        // console.log(Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100);
                        var gtotal_kh = ((gtotal * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100 : Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100;
                        
                        $('#twt_kh').text(money_comma(gtotal_kh)+ '៛');
                    } else {
                        $('#button_en__').text("KHR");
                        $('#button_kh__').text("USD");
                        var gtotal_kh = formatMoney(gtotal / kh_rate);
                        $('#twt_kh').text(formatMoney(gtotal_kh,'$'));
                        $('#twt').text(money_comma(gtotal) );
                        $('#quick-payable').text(gtotal);
                    }
                    //-------convert KH to EN--------
                    var gtotal_bat = parseFloat(gtotal * bat_rate);
        ...
        // $(document).on('focus', '#amount_1', function() {
        //     pi = $(this).attr('id');
        //     calculateTotals();
        // }).on('blur', '#amount_1', function() {
        //     calculateTotals(); 
        // });
        ...
        $(document).on('focus', '.amount_kh', function () {
            pi_kh = $(this).attr('id');
            calculateTotals();
        }).on('input', '.amount_kh', function () {
            calculateTotals();
        });
        
        $(document).on('focus', '.amount_bat', function () {
            pi_bat = $(this).attr('id');
            calculateTotals();
        }).on('input', '.amount_bat', function () {
            calculateTotals();
        });
        $(document).on('input, change', '#amount_1', function() {
            var total_paying = 0;
            pi = $(this).attr('id');
            calculateTotals();
        });
        ...
        $(document).on('change', '#amount_2', function() {
                ...
                var gtotal_en = parseFloat(gtotal);
                if (currency != "KHR") { 
                    var gtotal_kh = ((gtotal * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100 : Math.floor((parseFloat(gtotal) * kh_rate) / 100) * 100;
                } else { 
                    var gtotal_kh = formatMoney(gtotal / kh_rate); 
                ...
                var gtotal_bat = parseFloat(gtotal) * bat_rate;
                var amount_1   = $("#amount_1").val() ? $("#amount_1").val() : 0;
                var amount_2   = $("#amount_2").val();
                var amount_3   = $("#amount_3").val();
                //------- USD -------
                var amount_2_kh  = $("#amount_2").val() / riel_rate;
                var amount_3_bat = $("#amount_3").val() / bath_rate;
                var balance = parseFloat(amount_1) + parseFloat(amount_2_kh);
                // var balance = parseFloat(amount_1) + parseFloat(amount_2_kh) + parseFloat(amount_3_bat);
                //----------KH----------
                //var balance_kh=parseFloat(balance * riel_rate);
                // var balance_kh = ((balance * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(balance) * kh_rate) / 100) * 100 : Math.floor((parseFloat(balance) * kh_rate) / 100) * 100;
                if (currency != 'KHR') {
                    var balance_kh = ((balance * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(balance) * kh_rate) / 100) * 100 : Math.floor((parseFloat(balance) * kh_rate) / 100) * 100;
                } else {
                    var balance_kh = money_comma(balance * kh_rate);
                }
                //----------BATH-----------
                var balance_bat = parseFloat(balance * bath_rate);
                //-----------append-------
                //$('#balance').text(money_comma((gtotal_en - balance).toFixed(2)));
                // console.log(gtotal_kh);
                // console.log(balance);
                $('#balance_kh').text(formatMoney(money_comma(gtotal_kh - balance_kh)));
                $('#balance_bat').text(money_comma(Math.round(gtotal_bat - balance_bat).toFixed(3)));
                //-------------
                //$('#amount_val_1').val(balance);
                //$('#balance_amount_1').val(balance - gtotal);
                //$('#paid_amount_val_1').val(amount_1+','+amount_2+','+amount_3);
            });
            $(document).on('change', '#amount_3', function() {
                var gtotal_en = parseFloat(gtotal);
                var gtotal_kh = ((gtotal * kh_rate) % 100 >= 50) ? Math.ceil((parseFloat(gtotal) * kh_rate) / 100) * 100 : Math.floor((parseFloat(gtotal) * kh_rate) / 100) * 100;
                var gtotal_bat = parseFloat(gtotal) * bat_rate;
                var amount_1 = $("#amount_1").val() ? $("#amount_1").val() : 0;
                ...
                var balance = parseFloat(amount_1) + parseFloat(amount_2_kh) + parseFloat(amount_3_bat);
                //----------KH-----------
                var balance_kh = parseFloat((balance * riel_rate).toFixed(3));
                //----------BATH-----------
                var balance_bat = parseFloat(balance * bath_rate);
                //-----------append-------
                $('#balance').text(money_comma((gtotal_en - balance).toFixed(3)));
                $('#balance_kh').text(formatMoney(money_comma(gtotal_kh - balance_kh)));
                $('#balance_bat').text(money_comma(Math.round(gtotal_bat - balance_bat).toFixed(3)));
                //-------------
                //$('#amount_val_1').val(balance);
            ...
            function calculateTotals() {
                var total_paying = 0;
                var total_paying_kh = 0;
                var total_paying_bat = 0; 
                var ia = $(".amount");
                $.each(ia, function (i) {
                    var this_amount = formatCNum($(this).val() ? $(this).val() : 0);
                    total_paying += parseFloat(this_amount);
                ...
                var ia_kh = $(".amount_kh");
                $.each(ia_kh, function (i) {
                    if (currency != 'KHR') {
                        var this_amount = formatCNum($(this).val() ? $(this).val() / kh_rate : 0);
                    }else{
                        var this_amount = formatCNum($(this).val() ? $(this).val() * kh_rate : 0); 
                    }
                    total_paying_kh += parseFloat(this_amount);
                });
                var ia_bat = $(".amount_bat");
                $.each(ia_bat, function (i) {
                    if (currency != 'KHR') {
                        var this_amount = formatCNum($(this).val() ? $(this).val() / bat_rate : 0);
                    }else{
                        var this_amount = formatCNum($(this).val() ? $(this).val() * bat_rate : 0); 
                    }
                    total_paying_bat += parseFloat(this_amount);
                }); 
                total_paid = total_paying + total_paying_kh + total_paying_bat; 
                $('#total_paying').text(formatMoney(total_paid));
                <?php if ($pos_settings->rounding) { ?>
                    $('#balance').text(formatMoney(total_paid - round_total));
                    $('#balance_' + pi).val(formatDecimal(total_paid - round_total));
                    total_paid = total_paying;
                    grand_total = round_total;
                <?php } else { ?>
                    if (currency != 'KHR') {
                        $('#balance').text(formatMoney(gtotal - total_paid));
                        $('#balance_kh').text(money_comma(formatMoney((gtotal - total_paid) * kh_rate)));
                        $('#balance_bat').text(formatMoney((gtotal - total_paid) * bat_rate));
                    }else{
                        fgtotal = (((gtotal - total_paid) < 50) && ((gtotal - total_paid) > -50)) ? 0 : (gtotal - total_paid);
                        $('#balance').text(formatMoney(fgtotal));
                        $('#balance_kh').text(money_comma(formatMoney((gtotal - total_paid) / kh_rate)));
                        $('#balance_bat').text(formatMoney((gtotal - total_paid) / bat_rate));
                    } 
                    var pa_ = pa - 1;
                    $('#paid_' + pi).val($('#' + pi).val());
                    $('#paid_' + pi_kh).val($('#' + pi_kh).val());
                    $('#paid_' + pi_bat).val($('#' + pi_bat).val());
                    $('#balance_' + pi).val(formatDecimal(total_paid - gtotal));
                    grand_total = gtotal;
                <?php } ?>
            }
            ...
            $('#suspend').click(function() {
                if (count <= 1) {
                    ...
                    <?php if (
                        $pos_settings->pos_type == 'table' || $pos_settings->pos_type == 'room') { ?>
                        $('#suspend_sale').click();
                    <?php } else { ?>
                        $('#susModal').modal();
                    <?php } ?>
            ...
            $('#suspend_sale').click(function() {
                ...
                if (site.settings.module_gym) {
                    location.href = "<?= admin_url("pos/index/"); ?>"+ref+'/'+card_id;
                }
            });
        });
        $(document).ready(function() {
