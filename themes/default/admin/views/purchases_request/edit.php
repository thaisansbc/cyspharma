...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <?php if ($inv) { ?>
            ...
            localStorage.setItem('deadline', '<?= date($dateFormats['php_ldate'], strtotime($inv->deadline)) ?>');
        ...
        <?php } ?>
        <?php if ($Owner || $Admin) { ?>
            $(document).on('change', '#deadline', function(e) {
                localStorage.setItem('deadline', $(this).val);
            });
            if (deadline = localStorage.getItem('deadline')) {
                $('#deadline').val(deadline);
            }
        <?php } ?>
        ItemnTotals();
        $("#add_item").autocomplete({
            source: '<?= admin_url('purchases_request/suggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 250,
        ...
        $(document).on('click', '#addItemManually', function(e) {
            ...
            // $(document).ready(function() {
            //     if ($('#postatus').empty()) {
            //         $('#error').text(<?= lang('Status can not be null') ?>);
            //     }
            // });
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("purchases_request/edit/" . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group" style="width:100%">
                                    ...
                                    // var_dump(($_POST['project']) ? $_POST['project'] : $project_id);
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            $post = array(
                                ...
                                'reject' => lang('Reject'));
                            echo form_dropdown('status', $post, $purchase->status, 'id="postatus" data-placeholder="' . lang("select") . ' ' . lang("project") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                            ?>
                                ...
                                <table id="poTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php echo '<th class="col-md-2">' . $this->lang->line("description") . '</th>'; ?>
                                            <th class="col-md-1"><?= lang("net_unit_cost"); ?></th>
                                            <th class="col-md-1"><?= $this->lang->line("qoh"); ?></th>
                                            <th class="col-md-1"><?= lang("quantity"); ?></th>
                                            
                                            <?php if ($Settings->product_discount) {
                                                echo '<th class="col-md-1">' . $this->lang->line("product_discount") . '</th>';
                                            } ?>
                            ...
                            <?php if ($Owner || $Admin) { ?>
                                <div class="col-md-4 hide">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('deadline', (isset($_POST['deadline']) ? $_POST['deadline'] : $this->bpas->hrld($purchase->deadline)), 'class="form-control input-tip datetime" id="deadline"') ?>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('required_date', (isset($_POST['required_date']) ? $_POST['required_date'] : $this->bpas->hrld($purchase->required_date)), 'class="form-control input-tip datetime"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
