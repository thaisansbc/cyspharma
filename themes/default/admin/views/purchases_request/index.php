...
<script>
    $(document).ready(function () {
        oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('purchases_request/getPurchasesRequested' . ($biller_id ? '/' . $biller_id : '')) ?>',
            ...
            {column_number: 6, filter_default_label: "[<?=lang('required_date');?>]", filter_type: "text", data: []},
...
<?php if ($Owner || $GP['bulk_actions']) {
	    echo admin_form_open('purchases_request/purchase_actions', 'id="action-form"');
	}
?>
<div class="box">
    <div class="box-header">
        <?php $biller_title = ($biller_id ? $biller->name : ((isset($user_biller) && !empty($user_biller)) ? $user_biller->name : lang('all_billers'))); ?>
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?=lang('purchase_request') . ' (' . $biller_title . ')';?> </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('purchases_request/add') ?>">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<?=lang("delete_purchases_request")?>"
                                data-content="<p><?=lang('r_u_sure')?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?=lang('i_m_sure')?></a> <button class='btn bpo-close'><?=lang('no')?></button>"
                                data-html="true" data-placement="left">
                                <i class="fa fa-trash-o"></i> <?=lang('delete_purchases_request')?>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
					<?php echo admin_form_open("purchases_request"); ?>
                    <div class="row">
                        <div class="col-sm-4">
