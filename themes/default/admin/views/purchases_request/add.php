    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("purchases_request/add", $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="reference_purchase_no" value="<?php if (isset($purchase)) {
                                                                                                echo $purchase->reference_no;
                                                                                            } else {
                                                                                                echo "";
                                                                                            }
                                                                                            ?>">
                                    ...
                                    <table id="poTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php echo '<th class="col-md-1">' . $this->lang->line("qoh") . '</th>'; ?>
