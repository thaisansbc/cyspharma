                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group standard_combo">
                                            ...
                                            <?= form_input('lenghth', set_value('lenghth'), 'class="form-control tip" id="lenghth"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group all">
                                    ...
                                    <div class="row" id="extras-con" style="display: none;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group all">
                                                ...
                                                <?= form_input('moh_license_expiry_days', set_value('moh_license_expiry_days'), 'class="form-control input-tip date" id="moh_license_expiry_days"'); ?>
                                            </div>
                                        </div>
                                        
                                    </div>
                                    <div class="form-group all">
                                        <?= lang('product_detail', 'product_details') ?>
                                    ...
                                    <div class="form-group standard">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                echo form_input(
                                                    ...
                                                    'class="form-control ' . ($product ? '' : 'suppliers') . '" id="' . ($product && !empty($product->supplier1) ? 'supplier1' : 'supplier') . '" placeholder="' . lang('select') . ' ' . lang('supplier_name') . '" style="width:100%;"'
                                                );
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <?= form_input(
                                                    'supplier_part_no',
                                                    (isset($_POST['supplier_part_no']) ? $_POST['supplier_part_no'] : ''),
                                                    'class="form-control tip" id="supplier_part_no" placeholder="' . lang('supplier_code') . '"'
                                                ); ?>
                                            </div>
                                        </div>
