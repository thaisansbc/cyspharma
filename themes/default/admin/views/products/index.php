                ...
                <div id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang('pcf5', 'pcf5'); ?>
                                <?php echo form_input('pcf5', (isset($_POST['pcf5']) ? $_POST['pcf5'] : ''), 'class="form-control" id="pcf5"'); ?> 
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang('pcf6', 'pcf6'); ?>
                                <?php echo form_input('pcf6', (isset($_POST['pcf6']) ? $_POST['pcf6'] : ''), 'class="form-control" id="pcf6"'); ?> 
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
