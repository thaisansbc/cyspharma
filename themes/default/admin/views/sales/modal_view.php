                    ...
                    <tr>
                        <td>
                            <div class="col-xs-2">
                               ...
                               // if ($islogo) {
                                    if ($logo) { ?>
                                        <div><img style="height: 100px !important;" src="<?= base_url() . 'assets/uploads/logos/'.$biller->logo; ?>" ></div>
                                    <?php } ?>                                
                            </div>
                            <div class="col-xs-8" style="padding-left: 0; text-align: center;">
                                <h1 style="font-weight: bold; font-family: 'Khmer OS Muol Light';"><?= $biller->company && $biller->company != '-' ? $biller->company : $biller->name; ?></h1>
                                <h1 style="font-weight: bold; font-family: 'FontAwesome';">
                                    <?= $biller->name; ?></h1>
