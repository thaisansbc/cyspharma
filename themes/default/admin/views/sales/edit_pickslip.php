...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_pickslip'); ?></h2>
</div>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                    ...
                    echo admin_form_open_multipart('sales/edit_pickslip/' . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                        ...
                        <div class="col-md-12" id="sticker">
                                    ...
                                    <div class="controls table-controls">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hide"><?= lang('subtotal'); ?> (<span
                            ...
                            <?php if (empty($inv->delivery_status) || $inv->delivery_status == 'pending') { ?>
                            <div class="col-sm-4 hide">
                                <div class="form-group">
