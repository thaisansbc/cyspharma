...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_pickslip'); ?></h2>
</div>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($sale_order_id)) {
                    echo admin_form_open_multipart("sales/add_pickslip/".$sale_order_id, $attrib);
                } else {
                    echo admin_form_open_multipart("sales/add_pickslip", $attrib);
                }
                if ($sale_order_id) {
                ...
                <div class="row">
                                    ...
                                    <table id="slTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1 hide"><?= lang('net_unit_price'); ?></th>
                                                <th><?= lang('unit'); ?></th>
                    ...
                    <div id="bottom-total" class="well well-sm hide" style="margin-bottom: 0;">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#so_reference').on('change',function(){
            ...
            location.replace(site.base_url+"sales/add_pickslip/"+so_reference);
        });
    });
</script>