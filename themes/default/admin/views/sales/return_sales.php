<script>
    ...
    $(document).ready(function () {
        var oTable = $('#RESLData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getReturns'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
        ...
        <?php $this->bpas->unset_data('remove_rels'); } ?>
...
<?php //if ($Owner) {
   echo admin_form_open('sales/getReturnsAll_action/'.($warehouse_id ? $warehouse_id : ''), 'id="action-form"');
//} 
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						...
						<!-- <li><a href="<?= admin_url('sales/add_return') ?>"><i
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('sales/return_sales') ?>"><i
                                        class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                                echo '<li><a href="' . admin_url('sales/return_sales/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="RESLData" class="table table-hover table-striped">
                        <thead>
                        <tr>
...
<script>
	...
	// 		e.preventDefault();
	// 		window.location.href = "<?=admin_url('Sales/getReturnsAll/0/xls/')?>";
	// 		return false;
	// 	});
	// 	$('#pdf').click(function (event) {
 //            event.preventDefault();
 //            window.location.href = "<?=admin_url('Sales/getReturnsAll/pdf/?v=1'.$v)?>";
 //            return false;
 //        });
	// });
</script>