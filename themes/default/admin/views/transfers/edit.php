...
<script type="text/javascript">
    var Owner     = '<?= $Owner; ?>';
    var Admin     = '<?= $Admin; ?>';
    var show_cost = '<?= $GP['products-cost']; ?>';
</script>
<script type="text/javascript">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                if($this->Owner || $this->Admin){
                                     $post = ['completed' => lang('completed'), 'issued' => lang('issued'), 'viod' => lang('viod'),  'partial' => lang('partial')];     
                                } else {
                                    if($this->GP['transfers-approved']){
                                         $post = ['completed' => lang('completed'), 'issued' => lang('issued'), 'viod' => lang('viod'),  'partial' => lang('partial')]; 
                                    } else {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php if (($Owner || $Admin) || empty($user_billers)) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('biller', $bl, ($transfer->from_biller?$transfer->from_biller:$Settings->default_biller), 'id="from_biller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <?php } elseif (count($user_warehouses) > 1) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang('from_warehouse', 'from_warehouse'); ?>
                                            <?php
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('to_biller', $tbl, $transfer->to_biller, 'id="to_biller" data-placeholder="' . lang("select") . ' ' . lang("to_biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                            ?>
                                        </div>
                                    </div>
                    ...
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <?php if ($Settings->tax1) { ?>
                                <td class="show-cost"><?= lang('product_tax') ?> <span class="totals_val pull-right" id="ttax1">0.00</span></td>
                            <?php } ?>
