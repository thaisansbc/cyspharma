...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getRacks') ?>',
...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('rack'); ?></h2>
        ...
        <ul class="btn-tasks">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                    <li>
                        <a href="<?php echo admin_url('system_settings/add_rack'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                            <i class="fa fa-plus"></i> <?= lang('add_rack') ?>
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li>
