...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang('mobile_splish_logo', 'mobile_splish_logo') ?>
                <input id="mobile_splish_logo" type="file" data-browse-label="<?= lang('browse'); ?>" name="mobile_splish_logo" data-show-upload="false"
                       data-show-preview="false" class="form-control file">
                <small class="help-block"><?= lang('mobile_splish_logo_tip'); ?></small>
            </div>
            <div class="form-group">
                <?= lang('mobile_login_logo', 'mobile_login_logo') ?>
                <input id="mobile_login_logo" type="file" data-browse-label="<?= lang('browse'); ?>" name="mobile_login_logo" data-show-upload="false"
                       data-show-preview="false" class="form-control file">
                <small class="help-block"><?= lang('mobile_login_logo_tip'); ?></small>
            </div>
            <div class="form-group">
                <?= lang('mobile_header_logo', 'mobile_header_logo') ?>
                <input id="mobile_header_logo" type="file" data-browse-label="<?= lang('browse'); ?>" name="mobile_header_logo" data-show-upload="false"
                       data-show-preview="false" class="form-control file">
                <small class="help-block"><?= lang('mobile_header_logo_tip'); ?></small>
            </div>
        </div>
