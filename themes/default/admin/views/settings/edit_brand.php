    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group all hide">
                <?= lang('slug', 'slug'); ?>
                <?= form_input('slug', set_value('slug', $brand->slug), 'class="form-control tip" id="slug"'); ?>
            </div>

            <div class="form-group all">
                <?= lang('description', 'description'); ?>
                <?= form_input('description', set_value('description', $brand->description), 'class="form-control tip" id="description"'); ?>
            </div>
