                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('customer_limit', '', 'class="form-control" id="customer_limit" '); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?= lang('active_invoice', 'active_invoice'); ?>
                                    <?php echo form_input('active_invoice', '', 'class="form-control" id="active_invoice" '); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?= lang('credit_term', 'credit_term'); ?>
                                    <?php echo form_input('credit_term', '', 'class="form-control" id="credit_term" '); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('vat',$tax, '', 'class="form-control select" id="vat"'); ?>
                                </div>
                            </div>
