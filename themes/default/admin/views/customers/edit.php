        ...
        <div class="modal-body">
            ...
            <div role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="#additional"  role="tab" data-toggle="tab"><?= lang('additional')?></a>
                    </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="important">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?= lang('customer_limit', 'customer_limit'); ?>
                                    <?php echo form_input('customer_limit', $customer->customer_limit ?  $customer->customer_limit : ' ', 'class="form-control" id="customer_limit" '); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?= lang('active_invoice', 'active_invoice'); ?>
                                    <?php echo form_input('active_invoice',  $customer->active_invoice ?  $customer->active_invoice : ' ' , 'class="form-control" id="active_invoice" '); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?= lang('credit_term', 'credit_term'); ?>
                                    <?php echo form_input('credit_term',  $customer->credit_term ?  $customer->credit_term : ' ' , 'class="form-control" id="credit_term" '); ?>
                                </div>
                            </div>
                                ...
                                <?php 
                                    ...
                                    if (!empty($tax_rates)) {
                                        foreach ($tax_rates as $tax_rate) {
                                            $tax[$tax_rate->id] = $tax_rate->name;
                                        }
                                    }
                                    echo form_dropdown('vat',$tax, $customer->vat ? $customer->vat : '', 'class="form-control select" id="vat"'); ?>
                                </div>
                            </div>
