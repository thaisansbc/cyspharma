                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        <div class="text-center" style="border-bottom:1px solid #cccccc;padding-bottom:5px; ">
                            ...
                            <?php if ($Settings->logo) {
                                echo '<img width="150" src="'.base_url('assets/uploads/logos/' . $Settings->logo).'" alt="' . $Settings->site_name . '" style="margin-bottom:0px;" id="logo" />';
                        ...
                        if((($this->Settings->ui == 'full')? ($session_module =='asset' && $Settings->module_asset) : $Settings->module_asset) && ($Owner||$Admin||$GP['assets-index'] || $GP['assets-add']|| $GP['assets-expenses']||$GP['assets-depreciation']||$GP['products-using_stocks']||$GP['products-using_stocks-add'])){ ?>
                            <li class="mm_asset" id="mm_asset">
                                ...
                                <ul>
                                    ...
                                    <li id="assets_expenses" class="hide">
                        ...
                        <?php }
                        if ((($this->Settings->ui == 'full')? ($session_module =='procurement' && $Settings->module_purchase) : $Settings->module_purchase) && ($Owner||$Admin||$GP['purchases-index'] || $GP['purchases-add'] || $GP['purchases_request-index'] || $GP['purchases_request-add'] || $GP['purchases_order-index'] || $GP['purchases_order-add']|| $GP['suppliers-index']||$GP['suppliers-add'])) { ?>
                        ...
                        if ((($this->Settings->ui == 'full')? ($session_module =='sales' && $Settings->module_sale) : $Settings->module_sale) && ($Owner || $Admin ||$GP['sales_order-index']||$GP['sales-index'] || $GP['sales-add'] || $GP['sales-deliveries'] || $GP['sales-gift_cards'] || $GP['sales-view_sale_declare'] || $GP['customers-index']||$GP['customers-add']||$GP['drivers-index']||$GP['drivers-add'])) { 
                            ?>
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <?php } if ($Owner || $Admin ||$GP['sales-index']) { ?>
                                    <li id="sales_pick_slip">
                                        <a class="submenu" href="<?= admin_url('sales/pick_slip'); ?>">
                                            <i class="fa-regular fa fa-heart"></i><span class="text"> <?= lang('pick_slip'); ?></span>
                                        </a>
                                    </li>
                                    <?php } if ($Owner || $Admin ||$GP['sales-index']) { ?>
                                    <li id="sales_index">
                                    ...
                                    <li id="sales_shipping_request" class="hide">
                                    ...
                                    <li id="returns_index" class="hide">
                        ...
                        if (
                            ...
                            <li class="mm_pos">
                                ...
                                <ul>
                                    ...
                                    <?php } if ( ($Owner || $Admin || $GP['sales-customer_stocks'])) { ?>
                    ...
                    <?php } if($this->Settings->module_clearance && ($Owner || $Admin || $GP['reports-sales'] || $GP['clearances-sale_statement_report'] || $GP['clearances-containers'] || $GP['sales-index'] || $GP['clearances-expense_payment_report'] || $GP['clearances-income_by_booking_report'] || $GP['clearances-clearance_report'] || $GP['clearances-expense_by_booking_report'] || $GP['clearances-dry_ports'] || $GP['clearances-trucking_report'] || $GP['clearances-expense_payments'] || $GP['clearances-plan_report'] || $GP['clearances-booking_report'] || $GP['clearances-truckings'] || $GP['clearances-bookings'] || $GP['clearances-countries'] || $GP['clearances-ports'] || $GP['clearances-index'] || $GP['clearances-lines'])){ ?>
                        ...
                        if((($this->Settings->ui == 'full')? ($session_module =='accounting' && ($Settings->module_account)) : ($Settings->module_account)) && ($Owner||$Admin||$GP['accounts-index'] || $GP['account-list_receivable'] || $GP['account-list_ar_aging'] || $GP['account-ar_by_customer'] || $GP['account-bill_receipt'] || $GP['account-list_payable'] || $GP['account-list_ap_aging'] || $GP['account-ap_by_supplier'] || $GP['account-bill_payable'] || $GP['account-list_ac_head'] || $GP['account-list_customer_deposit'] || $GP['account-list_supplier_deposit'] || $GP['account_setting'])) {
                            ?>
                            <li class="mm_account mm_purchases">
                                <a class="dropmenu" href="#">
                                    <i class="fa-regular fa fa-book"></i>
                                ...
                                <ul>
                                    ...
                                    <?php } if ($Settings->module_account && ($Owner||$Admin||$GP['account-bill_receipt'])) { ?>
                                        ...
                                        <?php 
                                        if (($Settings->module_sale || $Settings->module_property) && ($Owner||$Admin||$GP['account-list_receivable'])){ ?>
                                        ...
                                        <?php } if ($Settings->module_purchase && ($Owner||$Admin||$GP['account-list_payable'])){ ?>
                                            <li id="account_list_ac_payable">
                                                <a class="submenu" href="<?= admin_url('account/list_ac_payable'); ?>">
                                                    <i class="fa-regular fa fa-list"></i><span class="text"> <?= lang('list_account_payable'); ?></span>
                                                </a>
                                            </li>
                            ...
                            ($this->Settings->ui == 'full')? ($Settings->module_hr && $session_module =='hr') : $Settings->module_hr
                             ...
                             && ($Owner || $Admin || $GP['hr-salary_reviews_report'] || $GP['hr-salary_reviews'] || $GP['hr-kpi_add'] || $GP['hr-id_cards'] || $GP['hr-id_cards_report'] || $GP['hr-sample_id_cards'] || $GP['hr-id_cards'] || $GP['hr-kpi_report'] || $GP['hr-employees_report'] || $GP['hr-banks_report'] || $GP['hr-kpi_index'] || $GP['hr-kpi_types'] || $GP['hr-index'] || $GP['hr-departments'] || $GP['hr-positions'] || $GP['hr-groups'] || $GP['hr-employee_types'] || $GP['hr-employees_relationships'] || $GP['hr-tax_conditions'] || $GP['hr-leave_categories'] || $GP['hr-leave_types'])) { ?>
                                ...
                                <li class="mm_hr hide">
                                    ...
                                    <ul> 
                                        <?php if($Owner || $Admin || $GP['hr-division']){ ?>
                                            <li id="hr_division">
                                                <a class="submenu" href="<?= admin_url('hr/division'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('division'); ?></span>
                                                </a>
                                            </li>
                                        <?php } if($Owner || $Admin || $GP['hr-on_boarding']){ ?>
                                            <li id="hr_on_boarding">
                                                <a class="submenu" href="<?= admin_url('hr/on_boarding'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('on_boarding'); ?></span>
                                                </a>
                                            </li>
                                        <?php }if($Owner || $Admin || $GP['hr-off_boarding']){ ?>
                                            <li id="hr_off_boarding">
                                                <a class="submenu" href="<?= admin_url('hr/off_boarding'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('off_boarding'); ?></span>
                                                </a>
                                            </li>
                                        <?php }if($Owner || $Admin || $GP['hr-candidate']){ ?>
                                            <li id="hr_candidate" class="hide">
                                ...
                                <li class="mm_hr">
                                    ...
                                    <?php } if($Owner || $Admin || $GP['hr-promotions']){ ?>
                                        <li id="hr_promotions" class="hide">
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php if($Settings->kpi_function &&($Owner || $Admin || $GP['hr-kpi_types'])) { ?>
                                            <li id="hr_kpi_types">
                                                <a class="submenu" href="<?= admin_url('hr/kpi_types'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('kpi_types'); ?></span>
                                                </a>
                                            </li>
                                        <?php } if($Settings->kpi_function &&($Owner || $Admin || $GP['hr-kpi_add'])){ ?>
                                            <li id="hr_print_kpi">
                                                <a class="submenu" href="<?= admin_url('hr/print_kpi'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('print_kpi'); ?></span>
                                                </a>
                                            </li>       
                                        <?php } if($Settings->kpi_function &&($Owner || $Admin || $GP['hr-kpi_index'])){ ?>
                                            <li id="hr_kpi">
                                                <a class="submenu" href="<?= admin_url('hr/kpi'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('kpi'); ?></span>
                                                </a>
                                            </li>
                                        <?php } 
                                        ?>
                         
                                        <?php if($Owner || $Admin || $GP['hr-training']) { ?>     
                                        <li>
                                            <a class="submenu" href="<?= admin_url('hr/training'); ?>">
                                                <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('training'); ?></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="submenu" href="<?= admin_url('system_settings/custom_field'); ?>">
                                                <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('training_type'); ?></span>
                                            </a>
                                        </li>
                                        <?php } if($Owner || $Admin || $GP['hr-trainers']) { ?> 
                                        <li>
                                            <a class="submenu" href="<?= admin_url('hr/trainers'); ?>">
                                                <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('trainer'); ?></span>
                                            </a>
                                        </li>
                                        <?php }?>
                                    </ul>
                        ...
                        if ($Owner || $Admin || $GP['system_settings']|| $GP['warehouses-index'] || $GP['system_settings-zones']) { ?>
                            <li class="mm_system_settings">
                                <a class="dropmenu" href="#">
                                    <i class="fa-regular fa fa-cog"></i><span class="text"> <?= lang('locations'); ?> </span><span class="chevron closed"></span>
                                </a>
                                <ul>
                                     <?php if($Settings->module_inventory && ($Owner || $Admin || $GP['warehouses-index'])){?>
                                    <li id="system_settings_categories">
                                        <a href="<?= admin_url('system_settings/warehouse_group') ?>">
                                            <i class="fa-regular fa fa-folder-open"></i><span class="text"> <?= lang('warehouse_group'); ?></span>
                                        </a>
                                    </li>
                                    <li id="system_settings_categories">
                                        <a href="<?= admin_url('system_settings/locations') ?>">
                                            <i class="fa-regular fa fa-folder-open"></i><span class="text"> <?= lang('locations'); ?></span>
                                        </a>
                                    </li>
                        ...
                        if ($Owner || $Admin || $GP['system_settings-telegrams'] || $GP['system_settings-cash_account'] || $GP['projects-index'] || $GP['system_settings'] || $GP['pos_settings'] || $GP['change_logo'] || $GP['billers-index'] || $GP['warehouses-index'] || $GP['system_settings-zones'] || $GP['expenses-categories'] || $GP['categories-index'] || $GP['tables-index'] || $GP['units-index'] || $GP['brands-index'] || $GP['variants-index'] || $GP['system_settings-boms'] || $GP['customer_groups-index'] || $GP['price_groups-index']|| $GP['payment_terms-index']|| $GP['currencies-index']|| $GP['customer_opening_balances-index']|| $GP['supplier_opening_balances-index']|| $GP['tax_rates-index']|| $GP['list_printers-index'] || $GP['email_templates-index'] || $GP['group_permissions-index'] || $GP['backups-index'] || $GP['system_settings-rooms'] || $GP['system_settings-rewards']) { ?>
                            <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="system_settings_units" class="hide">
                                        <a href="<?= admin_url('system_settings/units') ?>">
                                            <i class="fa-regular fa fa-wrench"></i><span class="text"> <?= lang('units'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="system_settings_commission_product" class="hide">
                                    ...
                                    <?php } if(($Settings->zone) && $Owner || $Admin || $GP['system_settings-zones']) {?>
                                    ...
                                    <li id="system_settings_custom_field">
                                        <a href="<?= admin_url('system_settings/custom_field?parent_id=243') ?>">
                                            <i class="fa-regular fa fa-wrench"></i><span class="text"> <?= lang('zone_group'); ?></span>
                                        </a>
                                    </li>
                          
                                    <li id="system_settings_areas">
                                        <a href="<?= admin_url('system_settings/areas') ?>">
                                            <i class="fa fa-building-o"></i><span class="text"> <?= lang('areas'); ?></span>
                                        </a>
                                    </li>   
                                    ...
                                    <li id="system_settings_payment_term">
                                     ...
                                     <li id="system_settings_payment_condition">
                                        <a href="<?= admin_url('system_settings/payment_condition') ?>">
                                            <i class="fa-regular fa-comments-dollar"></i><span class="text"> <?= lang('payment_condition'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="sub_mm_reports_purchases">
                                        ...
                                        <ul class="sub-sub-menu">
                                            ...
                                            <?php if ($Settings->multi_level) { ?>
                                                ...
                                                <li id="reports_budgets" class="hide">
                                                ...
                                                <li id="reports_expenses_budget" class="hide">
                                        ...
                                        <ul class="sub-sub-menu">
                                            ...
                                            <li id="reports_payments">
                                                <a href="<?= admin_url('account/tansfer_payment_report') ?>">
                                                    <i class="fa-regular fa fa-list"></i><span class="text"> dddd<?= lang('transfer_payment_report'); ?></span>
                                                </a>
                                            </li>
