<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EmployeeTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getEmployees/'.($biller ? $biller->id : '')); ?>',
            ...
            {column_number: 1, filter_default_label: "[<?=lang('empcode');?>]", filter_type: "text", data: []},
			{column_number: 2, filter_default_label: "[<?=lang('finger_id');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('first_name');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('last_name');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('gender');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('position');?>]", filter_type: "text", data: []},
			{column_number: 7, filter_default_label: "[<?=lang('department');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('phone');?>]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('employee_type');?>]", filter_type: "text", data: []},
			{column_number: 10, filter_default_label: "[<?=lang('employed_date');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		<h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('employees').' ('.($biller ? $biller->name : lang('all_billers')).')'; ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                ...
                <div class="table-responsive">
                    <table id="EmployeeTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:100px;"><?php echo lang('empcode'); ?></th>
							<th style="width:100px;"><?php echo lang('finger_id'); ?></th>
                            <th style="width:150px;"><?php echo lang('employee_name'); ?></th>
                            <th style="width:150px;"><?php echo lang('employee_name_kh'); ?></th>
                            <th style="width:150px;"><?php echo lang('gender'); ?></th>
                            <th style="width:150px;"><?php echo lang('position'); ?></th>
							<th style="width:180px;"><?php echo lang('department'); ?></th>
                            <th style="width:150px;"><?php echo lang('phone'); ?></th>	
							<th style="width:150px;"><?php echo lang('employee_type'); ?></th>								
                            <th style="width:150px;"><?php echo lang('employee_date'); ?></th>
