<div class="modal-dialog">
    <div class="modal-content">
		...
		<?php 
			...
			echo admin_form_open_multipart("hr/add_promotion/".$employee_id, $attrib); 
		?>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="form-group">
						...
						<div class="controls">
							<?php
								...
								echo form_dropdown('employee_type', $tp, $working_info->employee_type_id, 'id="employee_type" required class="form-control" ');
							?>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="controls">
							<?php
								...
								echo form_dropdown('position', $pot,$working_info->position_id, 'id="position" required class="form-control" ');
							?>
						</div>	
					</div>
					<div class="form-group">
						...
						<div class="controls">
							<?php
								...
								echo form_dropdown('department', $dpt, $working_info->department_id, 'id="department" required class="form-control" ');
							?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" name="promoted_date" class="form-control date" required/>
						</div>
					</div>
					<div class="form-group">
						<?php echo lang('official_promote', 'official_promote'); ?>
						<div class="controls">
							<input type="text" name="official_promote" class="form-control date"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="controls">
							<?php
								...
								echo form_dropdown('promoted_by', $emp, '', 'id="promoted_by" class="form-control" ');
							?>
						</div>
					</div>
					<div class="form-group">
