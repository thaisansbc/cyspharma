					...
					<div class="col-md-12">
						<div class="panel panel-warning">
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-2">
									<div class="form-group">
										<?= lang("profile_padding_bottom", "profile_padding_bottom"); ?>
										<?php echo form_input('profile_padding_bottom', (isset($_POST['profile_padding_bottom']) ? $_POST['profile_padding_bottom'] : $sample_id_card->profile_padding_bottom), 'class="form-control text-right" required="required" id="profile_padding_bottom"'); ?>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
...
<style>
	...
	.employee_photo{
		...
		margin-bottom:<?= $sample_id_card->profile_padding_bottom ?>%;
		text-align:center;
	}
	.employee_name{
		padding-top:3%;
	...
	.working{
		line-height : <?= ($sample_id_card->font_size + 10) ?>px;
		color : #d1cfcf !important;
	}
