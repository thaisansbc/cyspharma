...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_resignation'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("hr/edit_resignation/".$id_card->id, $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
								...
								<div class="col-md-4">
									...
									<div class="employee_box form-group">
										...
										foreach ($employees as $employee) {
											$em[$employee->id] = $employee->firstname.' '.$employee->lastname;
										}
						
											echo form_dropdown('employee', $em, (isset($_POST['employee']) ? $_POST['employee'] : $id_card->employee_id), 'id="employee" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("employee") . '"  class="form-control input-tip select" style="width:100%;"');
										?>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php echo form_input('notice_date', (isset($_POST['notice_date']) ? $_POST['notice_date'] : $this->bpas->hrsd($id_card->notice_date)), 'class="form-control input-tip date" required="required"'); ?>
									</div>
								</div>
								
								<div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang('resignation_date', 'resignation_date'); ?>
                                        <?php echo form_input('resignation_date', (isset($_POST['resignation_date']) ? $_POST['resignation_date'] : $this->bpas->hrsd($id_card->resignation_date)), 'class="form-control input-tip date" required="required"'); ?>
                                    </div>
                                </div>
