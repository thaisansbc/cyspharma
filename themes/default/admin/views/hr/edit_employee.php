...
<ul id="myTab" class="nav nav-tabs">
	...
	<li><a href="#off_boarding" class="tab-grey hide"><?= lang('off_boarding') ?></a></li>
...
<div class="tab-content">
						...
						<div class="table-responsive">
							<table id="onb" cellpadding="0" cellspacing="0" border="0"
								...
								<tr>
									...
									<th style="width:150px;"><i class="fa fa-chain"></i> <?php echo lang('experience_etter'); ?></th>
									<th style="width:250px;"><i class="fa fa-chain"></i> <?php echo lang('resume'); ?></th>
	...
	<div id="off_boarding" class="tab-pane fade">
		<div class="box">
			<div class="box-header">
				<h2 class="blue">
					<i class="fa-fw fa fa-newspaper-o"></i>
			...
			<div class="box-content">
				<div class="row">
					...
					<script type="text/javascript">
						$(document).ready(function () {
							'use strict';
							var oTable = $('#offb').dataTable({
								"aaSorting": [[1, "asc"], [3, "asc"]],
								"aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
								"iDisplayLength": <?= $Settings->rows_per_page ?>,
								'bProcessing': true, 
								'bServerSide': true,
								'sAjaxSource': '<?= admin_url('hr/getoffBoarding?employee_id='.$id) ?>',
								'fnServerData': function (sSource, aoData, fnCallback) {
									aoData.push({
										"name": "<?= $this->security->get_csrf_token_name() ?>",
										"value": "<?= $this->security->get_csrf_hash() ?>"
					...
					<div class="col-lg-12">
						<div class="table-responsive">
							<table id="offb" cellpadding="0" cellspacing="0" border="0"
								   class="table table-bordered table-hover table-striped dataTable">
								<thead>
								<tr>
									<th style="width:150px;"><?php echo lang('joining_date'); ?></th>
