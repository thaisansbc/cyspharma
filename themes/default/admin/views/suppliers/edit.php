            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group company">
                        ...
                        <?= form_input('contact_person', $supplier->contact_person, 'class="form-control" id="contact_person"');?>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang('local_address', 'local_address'); ?>
                        <?php echo form_input('cf5', $supplier->cf5, 'class="form-control" id="cf5"'); ?>

                    </div>
                    <div class="form-group">
                        <?= lang('oversea_address', 'oversea_address'); ?>
