...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('purchases/add_debit_payment/' . $inv->id, $attrib); ?>
                    ...
                    <div class="col-md-12">
                        <div class="row">                            
                            <div class="col-sm-12">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang('amount', 'amount_1'); ?> <?= abs($this->bpas->formatMoney(
                                               ($this->Settings->avc_costing)? (($inv->grand_total-$inv->shipping) - $inv->paid) : ($inv->grand_total - $inv->paid))) ?>
                            ...
                            foreach($currencies as $currency){
                                ...
                                $base_amount = $this->bpas->formatDecimal(abs($inv->grand_total - $inv->paid - $discount_inv) / $base_currency->rate);
