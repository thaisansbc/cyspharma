                ...
                <table id="CompTable" class="table table-hover table-striped">
                    ...
                    <?php if (!empty($payments)) {
                            ...
                            <tr class="row<?= $payment->id ?>">
                                ...
                                <td><?= abs($this->bpas->formatMoney($payment->amount)) . ' ' . (($payment->attachment) ? '<a href="' . admin_url('welcome/download/' . $payment->attachment) . '"><i class="fa fa-chain"></i></a>' : ''); ?></td>
                                <td><?= abs($this->bpas->formatMoney($payment->discount)); ?></td>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="<?= admin_url('purchases/edit_debit_payment/' . $payment->id) ?>"
                                           data-toggle="modal" data-backdrop="static" data-target="#myModal2"><i class="fa fa-edit"></i></a>
