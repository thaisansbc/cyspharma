...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('sales/getSales_pending' . ($warehouse_id ? '/' . $warehouse_id : '/0').($dt ? '/' . $dt : '')).'/?v=1'.$v?>',
...
<?php //if ($Owner) {
	    echo admin_form_open('account/receivable_actions/'.(isset($warehouse_id) ? $warehouse_id : ''), 'id="action-form"');
	//}
?>
            ...
            <?php } ?>
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=admin_url('account/list_ac_recevable')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            	foreach ($warehouses as $warehouse) {
                            	        echo '<li><a href="' . admin_url('account/list_ac_recevable/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            	    }
                                ?>
                        </ul>
                    </li>
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
				<?php echo admin_form_open("account/list_ac_recevable"); ?>
                    <div class="row">
                        <div class="col-sm-4">
        ...
        $('body').on('click', '#combine_pay', function(e) {
            ...
            var i = 0;
                ...
                if(b == true){
                    ...
                    $('#myModal').modal({remote: '<?= admin_url('sales/combine_payment_receivable');?>?data=' + arrItems + ''});
                    $('#myModal').modal('show');
                    return false;
                }
