    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open("account/settings", $attrib);
					...
					<div class="col-md-4 col-sm-4">
                        <div class="form-group">
							...
							<?php
								...
								echo form_dropdown('biller', $acc_section, '' ,'id="biller" class="form-control biller" data-placeholder="' . lang($biller_name) . '" style="width:100%;" ');
							?>
					...
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
							...
							<?php
								...
								echo form_dropdown('default_expense', $acc_exp, '' ,'id="default_expense" class="form-control" data-placeholder="' . $data->default_expense.'" style="width:100%;" ');
							?>
							<input type="hidden" value="<?= $data->default_expense;?>" name="cost_variant" class="form-control" style="width:100%;"/>
						</div>
					</div>
                </fieldset>
                <fieldset class="scheduler-border">
