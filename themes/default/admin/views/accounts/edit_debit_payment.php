...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('purchases/edit_debit_payment/' . $payment->id, $attrib); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" readonly value="<?= abs($this->bpas->formatDecimal($payment->amount)); ?>" type="text" id="amount_1" class="pa form-control kb-pad amount" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
