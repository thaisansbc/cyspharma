                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if ($Settings->product_expiry) {
                                                    echo '<th class="col-md-2 hide">' . $this->lang->line('expiry_date') . '</th>';
                                                } ?>
...
<script type="text/javascript">
    $(function(){
        $('#pu_reference').on('change',function(){
            ...
            if(!pu_reference){
                localStorage.setItem('remove_pols', true);
                location.replace(site.base_url+"account/add_debit_note");    
            }else{
                location.replace(site.base_url+"account/add_debit_note/"+pu_reference);
            }
        });
    });
</script>
