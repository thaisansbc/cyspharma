...
<div class="tab-content">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="small-box padding1010">
                            ...
                            <h3 class="bold"><?= $this->bpas->formatMoney(10000); ?></h3>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="small-box padding1010">
                            ...
                            <i class="icon fa fa-line-chart"></i>
                            <h3 class="bold"><?= $this->bpas->formatMoney(2000); ?></h3>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="small-box padding1010">
                            ...
                            <i class="icon fa fa-line-chart"></i>
                            <h3 class="bold"><?= $this->bpas->formatMoney(3000); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="vendors" class="tab-pane fade">
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-heart-o nb"></i><?= lang('vendors'); ?>
                </h2>
