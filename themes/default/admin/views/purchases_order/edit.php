...
<script type="text/javascript">
    var Owner     = '<?= $Owner; ?>';
    var Admin     = '<?= $Admin; ?>';
    var show_cost = '<?= $this->session->userdata('show_cost'); ?>';
</script>
<script type="text/javascript">
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_purchase_order'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($orderid)) {
                    echo admin_form_open_multipart("purchases_order/edit/" . $orderid, $attrib);
                } else {
                    echo admin_form_open_multipart("purchases_order/edit", $attrib);
                } ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("po_date", "podate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $purchase->deadline), 'class="form-control input-tip datetime" id="podate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("po_no", "poref"); ?>
                                <?php echo form_input('reference_no', $purchase->reference_no, 'class="form-control input-tip" id="poref"'); ?>
                                <input type="hidden" name="reference_purchase_no" value="<?php if (isset($purchase)) { echo $purchase->purchase_ref; } else { echo ""; } ?>">
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group" id="btn">
                            ...
                            echo form_dropdown('status', $post, (isset($_POST['status']) ? $_POST['status'] : ''), 'id="poststatus" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("status") . '" required="required" style="width:100%;" ');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <?php
                                    ...
                                    echo form_dropdown('currency', $cu, (isset($_POST['currency']) ? $_POST['currency'] : $purchase->currency), 'class="form-control tip" id="currency" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="poTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                    <thead>
                                        <tr>
                                            ...
                                            // }
                                            ?>
                                            <th class="col-md-1 show-cost"><?= lang("net_unit_cost"); ?></th>
                                            ...
                                            <?php
                                            if ($Settings->tax1) {
                                                echo '<th class="col-md-1 show-cost">' . $this->lang->line("product_tax") . '</th>';
                                            } ?>
                                            <th class="show-cost"><?= lang("subtotal"); ?> (<span class="currency"><?= $default_currency->code ?></span>)</th>
                        ...
                        <div class="row" id="extras-con" style="display: none;">
                            ...
                            <div class="col-md-4 show-cost">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('discount', '', 'class="form-control input-tip input_decimal_percentage" id="podiscount"'); ?>
                                </div>
                            </div>
                            <div class="col-md-4 show-cost hide">
                                <div class="form-group">
                                    <?= lang("shipping", "poshipping"); ?>
                                    <?php echo form_input('shipping', '', 'class="form-control input-tip input_decimal" id="poshipping"'); ?>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php 
                                        echo form_input('payment_term', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('payment_term_tip') . '" id="popayment_term"');
                                        //$pt[''] = '';
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("eta", "eta"); ?>
                                    <?php echo form_input('eta', (isset($_POST['eta']) ? $_POST['eta'] : $this->bpas->hrld($purchase->eta)), 'class="form-control input-tip datetime"'); ?>
                                </div>
                            </div>
                            <?php if ($Owner || $Admin) { ?>
                                <div class="col-md-4 hide">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('deadline', (isset($_POST['deadline']) ? $_POST['deadline'] : $this->bpas->hrld($purchase->deadline)), 'class="form-control input-tip datetime" id="podate"') ?>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="col-md-4">
            ...
            <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                <table class="table table-condensed totals" style="margin-bottom:0;">
                    <tr class="warning">
                        ...
                        <td class="show-cost"><?= lang('total') ?> <span class="totals_val pull-right" id="total">0.00</span></td>
                        <td class="show-cost"><?= lang('order_discount') ?> <span class="totals_val pull-right" id="tds">0.00</span></td>
                        <?php if ($Settings->tax2) { ?>
                            <td class="show-cost"><?= lang('order_tax') ?> <span class="totals_val pull-right" id="ttax2">0.00</span></td>
                        <?php } ?>
                        <td class="show-cost"><?= lang('shipping') ?> <span class="totals_val pull-right" id="tship">0.00</span></td>
                        <td class="show-cost"><?= lang('grand_total') ?> <span class="totals_val pull-right" id="gtotal">0.00</span></td>
                    </tr>
                </table>
            </div>
            <?php echo form_close(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    <?php if ($Settings->tax1) { ?>
                        <div class="form-group show-cost">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control input_decimal" id="pquantity">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label"><?= lang('sub_option') ?></label>
                        <div class="col-sm-8">
                            <div class="controls" id="subcat_data"> 
                                <?php echo form_input('sub_option', '', 'class="form-control" id="sub_option"  placeholder="' . lang("select_option_to_load") . '"'); ?>
                            </div>
                        </div>
                    </div>
                    <?php if ($Settings->product_discount) { ?>
                        <div class="form-group show-cost">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control input_decimal_percentage" id="pdiscount">
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group show-cost">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control input_decimal" id="pcost">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <table class="table table-striped show-cost">
                        <tr>
                    ...
                    <div class="panel panel-default show-cost">
