    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($orderid)) {
                    echo admin_form_open_multipart("purchases_order/add/" . $orderid, $attrib);
                } else {
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="reference_purchase_no" value="<?php if (isset($purchase)) { echo $purchase->reference_no; } else { echo ""; } ?>">
                            </div>
                        </div>
                        <?php if($this->Settings->purchase_request) {  ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("pr_no", "pr_no"); ?>
                                    <?php
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang("eta", "eta"); ?>
                                        <?php echo form_input('eta', (isset($_POST['eta']) ? $_POST['eta'] : ""), 'class="form-control input-tip datetime"'); ?>
                                    </div>
                                </div>
                                <div class="col-md-4 hide">
                                    <div class="form-group">
                                        <?= lang("Deadline", "Deadline"); ?>
                                        <?php echo form_input('deadline', (isset($_POST['deadline']) ? isset($_POST['deadline']) : ''), 'class="form-control input-tip datetime" id="podate"'); ?>
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
