...
<script>
    $(document).ready(function () {
		oTable = $('#MLTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/get_daily_sales_profit?v=1&'. $v)?>',
...
<?php echo admin_form_open("reports/daily_sale_lists", ' id="form-submit" '); ?>

<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('daily_sale_profit'); ?></h2>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="MLTable" class="table table-bordered table-hover table-striped dataTable">
                        ...
                        <tr>
                            <th><?= lang("date"); ?></th>
							<th><?= lang("begining_qty"); ?></th>
							<th><?= lang("begining_amount"); ?></th>
