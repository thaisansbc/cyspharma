...
<script type="text/javascript">
    ...
    <?php if ((isset($orderid) && $orderid) || (isset($quote_id) && $quote_id) || (isset($plan_id) && $plan_id)) { ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($orderid) && $orderid) {
                    echo admin_form_open_multipart("purchases/add/".$orderid, $attrib);
                }elseif (isset($quote_id) && $quote_id) {
                    echo admin_form_open_multipart("purchases/add/0/".$quote_id, $attrib);
                }elseif (isset($plan_id) && $plan_id) {
                    echo admin_form_open_multipart("purchases/add/0/0/".$plan_id, $attrib);
                }else {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if (isset($orderid) || isset($quote_id) || isset($plan_id)) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("order_ref", "order_ref"); ?>
                                    <?php echo form_input('order_ref', (isset($purchase) ? $purchase->reference_no : ''), 'class="form-control input-tip" id="order_ref" readonly'); ?>
                                </div>
                            </div>
                        <?php } ?>
                                    ...
                                    <table id="poTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1"><?= lang('rack'); ?></th>
                                                <?php if ($Settings->using_weight) {
                                                    echo '<th class="col-md-1">' . $this->lang->line('weight') . '</th>';
                                                } ?>
                                ...
                                <?php if ($Settings->tax2 || $Settings->tax1) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" style="width:100%">
                                                <SELECT class="form-control input-tip select" id="potax2" name="order_tax" style="width:100%;">
                                                    <?php
                                                    $tr[''] = '';
