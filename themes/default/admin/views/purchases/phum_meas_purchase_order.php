                        ...
                        ?>
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    ...
                                    <?= ($row->expiry && $row->expiry != '0000-00-00') ? '<br>' . $this->bpas->hrsd($row->expiry) : ''; ?>
                                </td> 
                                ...
                                <?php
                                if ($inv->status == 'partial') {
                                    echo '<td style="text-align:center;vertical-align:middle;width:80px;">'.$this->bpas->formatQuantity($row->quantity_received).'</td>';
                                }
                                ?>
                                <?php if($Owner || $Admin || $GP['purchase_request-cost']) {?>
                                    <td style="text-align:right; width:100px; vertical-align: middle;"><?= $this->bpas->formatMoney($row->unit_cost); ?></td>
                                <?php } ?>
                                <?php
                                if ($Settings->tax1) {
                                    echo '<td style="width: 100px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>('.$row->tax_code.')</small>' : '') . ' ' . $this->bpas->formatMoney($row->item_tax) . '</td>';
                                }
                                if ($Settings->product_discount) {
                                ...
                                ?>
                                <td style="text-align:right; width:120px; vertical-align: middle;"><?= $this->bpas->formatMoney($row->subtotal); ?></td>
                    ...
                    <tfoot style="font-size: 13px;">
                        ...
                        <tr>
                            <td colspan="<?= $col; ?>" style="border-left:1px solid #fff !important;border-bottom:1px solid #fff !important;">
                                <p style="text-align:left; font-weight:bold;"><?= lang("note"); ?>:<?= $this->bpas->decode_html($inv->note); ?></p>
                            </td>
                            <td colspan="2"
                                style="text-align:right; padding-right:10px; font-weight:bold; vertical-align: middle;"><?= lang("total"); ?>
                                (<?= $default_currency->code; ?>)
                            </td>
                            <td style="text-align:right; padding-right:10px; font-weight:bold; vertical-align: middle;"><?= $this->bpas->formatMoney($inv->grand_total); ?></td>
                        </tr>
