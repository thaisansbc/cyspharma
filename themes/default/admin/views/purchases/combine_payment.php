...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("purchases/combine_payment_pur", $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>
            <?php 
            if ((!$Owner && !$Admin) && $this->config->item('requested_ap') && $GP['purchases-payments_requested']) {
            ?>
			...
			<div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <th style="width:18%;" class="hide"><?= $this->lang->line("discount"); ?></th>
                    ...
                    <?php if (!empty($combine_sales)) {
                        foreach ($combine_sales as $combine_sale) { ?>
                            <tr class="row<?= $combine_sale->id ?>">
                                ...
                                <td class="hide"><input type="text" name="discount_paid[]" class="discount_paid form-control" value="0" /></td>
								<td class="col-xs-3">
                    ...
                    <tfoot>
                        <tr>
							...
							<td class="hide"><strong id="total_discount"><?= $this->bpas->formatDecimal(0); ?></strong></td>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->bpas->formatDecimal($total); ?>"
