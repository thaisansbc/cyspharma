			...
			<tbody>
				...
				<tr>
					...
					<td style=" text-align:center; vertical-align:middle;">
						<?php 
							if($row->piece != 0){ 
								...
								echo $this->bpas->formatQuantity($row->quantity);}
						?>
					</td>
					<td style=" text-align:center; vertical-align:middle;">
					...
					<td style="text-align:left; vertical-align:middle;">
						...
						<div class="col-xs-7 text-left">
							<?= $row->subtotal!=0 ? $this->bpas->formatMoney($row->subtotal):$free; 
									$total += $row->subtotal;
									?>
						</div>
				...
				<tr>
					<td colspan="6" rowspan="<?= $rSpan ?>" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">
						...
						<p><?= $this->bpas->decode_html($inv->note);?></p>
					</td>
				...
				<tr>
					...
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
							<?=$this->bpas->formatMoney($inv->order_discount);?>
						</div>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
							<?=$this->bpas->formatMoney($inv->grand_total);?>
						</div>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
							<?=$this->bpas->formatMoney($inv->paid);?>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
							<?=$this->bpas->formatMoney($inv->grand_total - $inv->paid); ?>
						</div>
					</td>
				</tr>
				<?php }?>
