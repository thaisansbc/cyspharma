...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <?php if ($quote_id) { ?>
            ...
            localStorage.setItem('slsaleman_by', '<?= $quote->saleman_by ?>');
        ...
        if (!localStorage.getItem('srref')) {
            localStorage.setItem('srref', '<?= $slnumber ?>');
        }
        if (!localStorage.getItem('sltax2')) {
        ...
        $("#add_item").autocomplete({
            source: function(request, response) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('sales_order/suggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                    ...
                    echo admin_form_open_multipart('sales_order/add', $attrib);
                    if ($quote_id) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('reference_no', 'srref'); ?>
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $slnumber), 'class="form-control input-tip" id="srref"'); 
                                ?>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="slsaleman_by" name="saleman_by" class="form-control input-tip select">
                                                <option value=""><?= lang('select') . ' ' . lang('saleman') ?></option>
                                                <?php if ($this->session->userdata('group_id') == $Settings->group_saleman_id) {
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                if ($Settings->product_serial) {
                                                    echo '<th class="col-md-2">' . lang('max_serial') . '</th>';
                                                } ?>
                                                <th class="col-md-1"><?= lang('unit_price'); ?></th>
                                                <?php if ($Settings->show_qoh) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="width:100%">
                                        <!-- <SELECT class="form-control input-tip select" name="order_tax" style="width:100%;"> -->
                                            ...
                                            echo form_dropdown('order_tax',$tr, $dataCustomer->vat ? $dataCustomer->vat : $Settings->default_tax_rate2, 'class="form-control select" id="vat"'); 
                                            // echo form_dropdown('order_tax', $tr, $dataCustomer->vat ? $dataCustomer->vat : $Settings->default_tax_rate2, 'id="sltax2" data-placeholder="' . lang('select') . ' ' . lang('order_tax') . '" class="form-control input-tip select" style="width:100%;"'); 
                                            ?>
                                        <!-- </SELECT> -->
                                        <?php if ($Owner || $Admin) { ?>
                                            <div class="input-group-addon no-print" style="padding: 2px 8px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('credit_term', 'credit_term'); ?>
                                <?php echo form_input('credit_term', $dataCustomer->credit_term ? $dataCustomer->credit_term : '', 'class="form-control input-tip" id="credit_term"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group"><?php echo form_submit('add_sale', lang('submit'), 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
