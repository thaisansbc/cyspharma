...
<script>
    $(document).ready(function () {
        oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('quotes/getQuotes' . ($biller_id ? '/' . $biller_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <h2 class="blue"><i class="fa-fw fa fa-heart-o"></i><?= lang('quotes') . ' (' . $biller_title . ')';?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="<?= admin_url('quotes/quotes_by_csv') ?>">
                                <i class="fa fa-heart-o"></i> <?= lang('add_quote_by_csv') ?>
                            </a>
                        </li>
                        <li>
