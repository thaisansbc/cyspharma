...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-line-chart"></i><?= lang('stock_value'), ' (' . date('M-Y', time()) . ')'; ?></h2>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-md-12">
...
<?php } ?>
<?php if (($Owner || $Admin) && $chatData && $Settings->module_sale) { ?>
        ...
        $(function () {
            ...
            $('#employees_department').highcharts({
                ...
                series: [{
                    name: 'Medals',
                    data: [
                        <?php  if($total_employees_department) {
