...
<section class="page-contents">
    ...
    <div class="container">
      <h2 class="home-items_title text-center">Check out our products, vendors</h2>
        <p class="home-items_subtitle text-center">We carefully review new entries from our community one by one to make sure they meet high-quality products. From PHP scripts to Bootstrap skins, you’re always sure to find high-quality assets created by brilliant professionals.</p>
    </div>

    <?php if ($business_name) {?>
    <div class="container" style="padding: 10px;">
        <?php 
        foreach($business_name as $bn){
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="product" style="z-index: 1;">
                                    <div class="details" style="transition: all 100ms ease-out 0s;">
                                        ...
                                        <img width="100%" src="<?= base_url('assets/uploads/' . $product['image']); ?>" alt="">
