...
class Customers extends MY_Controller
{
        ...
        if ($this->form_validation->run('companies/add') == true) {
            ...
            $data = [
              ...
              //  'find_consumer_comission'   => $this->input->post('find_consumer_comission') ? $this->input->post('find_consumer_comission') : null,
                ...
                'customer_limit'            => $this->input->post('customer_limit') ? $this->input->post('customer_limit') : null,
                'active_invoice'            => $this->input->post('active_invoice') ? $this->input->post('active_invoice') : null,
    ...
    public function suggestionsCustomer($term = null, $limit = null)
    {
       // $this->bpas->checkPermissions('index');
       if ($this->input->get('term')) {
            $term = $this->input->get('term', true);
        ...
        $limit           = $this->input->get('limit', true);
        $results = $this->companies_model->getCustomersSuggestions($term, $limit);
