...
class Expenses extends MY_Controller
{
    ...
    public function add_expense($biller_id=false,$project_id=false)
    {
    ...
    public function add_payment($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if($this->Settings->module_account == 1){
                ...
                $narrative = $this->site->getAccountName($purchase->bank_account);
                ...
                $accTranPayments[] = array(
                        ...
                        'tran_date'     => $date,
                        'reference_no'  => $reference_no,
                        'account_code'  => $purchase->bank_account,
                        ...
                        'created_by'    => $this->session->userdata('user_id'),
                        'activity_type' => $this->site->get_activity($narrative)
                    );
                $accTranPayments[] = array(
                        'tran_type'     => 'Payment',
                        'tran_date'     => $date,
        ...
        if ($this->form_validation->run() == true) {
            ...
            if($this->Settings->module_account == 1){
                ...
                $accTranPayments[] = array(
                    ...
                    'supplier_id'   => $purchase->supplier_id,
                    'created_by'    => $this->session->userdata('user_id'),
                    'activity_type' => $this->site->get_activity($purchase->bank_account)
                );
                $accTranPayments[] = array(
                    'tran_type'     => 'Payment',
                    'tran_no'       => $id,
